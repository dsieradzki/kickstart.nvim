...
```sh
git clone https://github.com/dsieradzki/kickstart.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone git@github.com:dsieradzki/kickstart.nvim.git %userprofile%\AppData\Local\nvim\
```

If you're using `powershell.exe`

```
git clone git@github.com:dsieradzki/kickstart.nvim.git $env:USERPROFILE\AppData\Local\nvim\
```
